      ...
      <article className="mx-auto max-w-4xl">
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed">
            ...
            teams across the Americas. Hands-on technical leader who codes daily
            while driving strategy and mentoring teams.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-2">
            <p>
              <strong className="text-gray-900">Languages & Frameworks:</strong>{" "}
            ...
            <p>
              ...
              AWS (CDK, S3, CloudFront, Lambda), Docker, CI/CD (Jenkins, GitHub
              Actions)
            </p>
            <p>
            ...
            <p>
              <strong className="text-gray-900">Practices:</strong> Agile/Scrum,
              Code Review, TDD, Remote Team Management
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-6">
            {/* Oncue */}
            <div>
              <h3 className="text-lg font-semibold">Director of Engineering</h3>
              ...
              <ul className="list-disc ml-5 space-y-1 text-gray-700">
                ...
                <li>
                  <strong>Hands-on technical leadership</strong>: wrote features
                  and reviewed code for critical projects including Web booking
                  lead form, next-gen CRM, Customer Portal, and Reporting
                  dashboard
                </li>
                <li>
                  <strong>Architected and developed core services</strong> using
                  TypeScript, GraphQL, AWS, and Next.js
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc ml-5 space-y-1 text-gray-700">
                ...
                <li>
                  Built GDPR-compliant system to handle data requests, auditing,
                  and user data removal
                </li>
                <li>
                  Implemented California Consumer Privacy Act (CCPA) UI and IAB
                  User Signal API
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc ml-5 space-y-1 text-gray-700">
                <li>
                  Lead iOS developer for Constant Contact&apos;s email marketing
                  app
                </li>
                <li>
                  Created Model-View-Presenter (MVP) architecture to improve UI
                  testability
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc ml-5 space-y-1 text-gray-700">
                ...
                <li>
                  Created Angular.js prototype demonstrating grid-based shopping
                  cart design
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">
                <strong className="text-gray-900">Various Clients</strong> · San
                Francisco Bay Area · 2005 – 2012
              </p>
              <div className="ml-4 space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc ml-5 space-y-1 text-gray-700">
                    <li>
                      Developed CEO Workstation, a highly interactive web-based
                      cash management app
                    </li>
                    <li>
                      Built features for Online Bill Payment service using XSLT
                      templates
                    </li>
                  </ul>
                </div>
            ...
            <div>
              ...
              <ul className="list-disc ml-5 space-y-1 text-gray-700">
                <li>
                  Managed team of 6 developers delivering all web-based products
                </li>
                <li>
