...
const websiteJsonLd = {
  ...
  description:
    "Personal website and blog of Byron Warner, engineering leader and developer based in San Francisco.",
  author: {
    "@type": "Person",
    name: "Byron Warner",
    url: "https://warnerware.com",
...
const personJsonLd = {
  ...
  jobTitle: "Director of Engineering",
  description:
    "Engineering leader with 20+ years of experience building products and leading teams.",
  sameAs: [
    "https://www.linkedin.com/in/byronwarner/",
    "https://github.com/bwarner",
    "https://x.com/bewarned",
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-5 text-gray-600 text-lg leading-relaxed">
                ...
                <p>
                  I believe great software comes from great teams. My focus is
                  on building cultures of innovation, mentorship, and continuous
                  improvement.
                </p>
                <Link
                  href="/about"
